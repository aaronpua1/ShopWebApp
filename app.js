...
app.get('/create-offer', function(req, res) {
    ...
    async.parallel([
        function(callback) {
            var requests = [{
                method: "GET",
                url: 'https://' + req.session.shop + '.myshopify.com/admin/metafields.json?limit=250&fields=value,key&namespace=suo',
                headers: {
                    'X-Shopify-Access-Token': req.session.access_token
                }
            }];
                ...
                function(products, callback) {
                    ...
                    if (pages > 0) {
                        ...
                        function(err, results) {
                            ...
                            console.log("GET PRODUCT RESULTS: " + JSON.stringify(unique_vendors));
